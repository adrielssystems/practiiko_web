      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3 mt-2">
          ...
          <a 
            ...
            className="relative bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white py-3.5 px-2 rounded-xl font-black text-xs uppercase text-center flex items-center justify-center gap-1.5 transition-all hover:shadow-[0_8px_16px_rgba(37,211,102,0.4)] hover:-translate-y-0.5 no-underline animate-[pulse_2s_infinite] shadow-[0_4px_10px_rgba(37,211,102,0.2)]"
          >
