      ...
      <div className="max-w-[1280px] mx-auto bg-gradient-to-r from-[#F28705] to-[#F2A341] rounded-[32px] p-12 relative overflow-hidden group">
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-white">
            <h2 className="font-headline-lg text-headline-lg mb-2">¡Muebles de Lujo con Envío GRATIS a Todo el País!</h2>
            <p className="text-lg opacity-90">Transforma tu hogar con nuestra exclusiva línea de mobiliario premium. Calidad de vanguardia entregada directamente en tu puerta en toda Venezuela.</p>
          </div>
