  ...
  if (isDev && !hasDb) {
    return [
      { 
        ...
        price_bcv: 630,
        price_cash: 630, 
        description: "Experimenta la máxima relajación con nuestro sofá individual de alta gama. Diseño ergonómico con espumas de alta densidad, ideal para salas modernas en Venezuela. Calidad superior que llega en caja.",
      ...
      { 
        ...
        price_bcv: 685,
        price_cash: 685, 
        description: "Optimiza tu espacio con este sofá cama premium de líneas rectas. Perfecto para apartamentos en toda Venezuela. Tapicería resistente y ensamble intuitivo sin herramientas.",
        main_image: "/hero-sofa.png", 
      ...
      { 
        ...
        price_bcv: 325,
        price_cash: 325, 
        description: "Colchón ortopédico de espuma comprimida al vacío. Tecnología de soporte reforzado y textiles frescos. El mejor descanso en Venezuela, entregado directamente en tu puerta.",
        main_image: "/hero-sofa.png", 
